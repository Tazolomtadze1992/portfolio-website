...
export default function CadenceCaseStudyPage() {
  return (
    <main className="min-h-svh pt-16 sm:pt-24">
      <SiteContainer className="pb-24 max-w-[1200px] px-12">
        <div className="w-full space-y-24">
            ...
            <section className="space-y-8">
              <div className="grid w-full grid-cols-1 md:grid-cols-12 md:gap-x-8">
                ...
                <div className="mt-6 md:mt-0 md:col-start-7 md:col-span-6 text-sm text-muted-foreground">
            ...
            <section
              id="opportunity"
              className="grid w-full grid-cols-1 md:grid-cols-12 md:gap-x-8"
            >
              ...
              <div className="md:col-start-4 md:col-span-6 mt-10">
                <div className="media-surface overflow-hidden">
                  <Image
            ...
            <section id="workflows" className="space-y-24">
              ...
              <div className="grid w-full grid-cols-1 md:grid-cols-12 md:gap-x-8 md:items-start">
            ...
            >
              ...
              <div className="md:col-start-4 md:col-span-6 mt-8">
                <div className="media-surface overflow-hidden bg-[#F8F8F8] px-12 py-10">
                  <Image
                    src="/cadence/system.svg"
            ...
            <section
              ...
              className="grid w-full grid-cols-1 md:grid-cols-12 md:gap-x-8"
            >
              <h2 className="md:col-start-4 md:col-span-6 text-lg font-medium">
                Interface
              </h2>
              <p className="md:col-start-4 md:col-span-6 mt-2 text-base text-muted-foreground">
            ...
            >
              ...
              <div className="md:col-start-9 md:col-span-4 mt-6 md:mt-0">
